...
import com.musicentertainment.adapter.AdapterCountry;
import com.musicentertainment.asyncTask.LoadCountry;
import com.musicentertainment.countrymusic.R;
import com.musicentertainment.countrymusic.SongByCatActivity;
import com.musicentertainment.interfaces.CountryListener;
                ...
                AdLoader adLoader = builder.forNativeAd(
                        new NativeAd.OnNativeAdLoadedListener() {
                            ...
                            public void onNativeAdLoaded(@NonNull NativeAd nativeAd) {
                                adapterCountry.addAds(nativeAd);
                            }
                        }
                ).build();
