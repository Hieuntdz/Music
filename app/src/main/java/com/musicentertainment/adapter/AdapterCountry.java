...
public class AdapterCountry extends RecyclerView.Adapter {
    ...
    public AdapterCountry(Activity context, ArrayList<ItemCountry> arrayList) {
...
//                            CardView cardView = (CardView) ((Activity) context).getLayoutInflater().inflate(R.layout.layout_native_ad_admob, null);
                            ...
                            com.google.android.gms.ads.nativead.NativeAdView adView = (NativeAdView) ((Activity) context).getLayoutInflater().inflate(R.layout.layout_native_ad_admob, null);
